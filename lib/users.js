...
module.exports = class {
  ...
  get (userId, params, cb) {
    const version = userId.indexOf('@') === 0 ? 'v4' : 'v5'

    this.client.get(`/${version}/users/${userId}`, params, cb)
  }
  ...
  update (userId, params, cb) {
    const [version, method] =
      userId.indexOf('@') === 0 ? ['v4', 'put'] : ['v5', 'patch']

    this.client[method](`/${version}/users/${userId}`, params, cb)
  }
  ...
  delete (userId, cb) {
    ...
    this.client.delete(`/${version}/users/${userId}`, cb)
  }
}
